...
{
    //extends RecyclerView.Adapter<BoardAdapter.ViewHolder> {
...
//        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_board_node_alice, viewGroup, false);
